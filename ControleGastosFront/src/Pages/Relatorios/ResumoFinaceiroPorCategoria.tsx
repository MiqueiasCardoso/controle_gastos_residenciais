...
function RelatorioResumoFinanceiroPorCategoria() {
  ...
  async function carregarDados() {
    try {
      const data = await TransacaoService.getResumoPorCategoria()
      setResumo(data)
    } catch (err) {
...
export default RelatorioResumoFinanceiroPorCategoria